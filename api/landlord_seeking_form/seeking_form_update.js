...
const URL_seeking_elastic_dialog_map = require('../mapping_locations').getMap().URL_seeking_elastic_dialog_map
const URL_seeking_typeform_elastic_map = require('../mapping_locations').getMap().URL_seeking_typeform_elastic_map
...
const saveNewMappingsToS3 = () => {
  ...
  console.log(`seeking_elastic_dialog_map and seeking_typeform_elastic_map`)
  console.log('\n \n')
  const x = [
    uploadS3(URL_seeking_elastic_dialog_map, JSON.stringify(seeking_elastic_dialog_map)),
    uploadS3(URL_seeking_typeform_elastic_map, JSON.stringify(seeking_typeform_elastic_map))
  ]
  Promise.all(x)
    .then((data) => {
