...
const URL_advanced_elastic_dialog_map = require('../mapping_locations').URL_advanced_elastic_dialog_map
...
const saveNewMappingsToS3 = () => {
  ...
  console.log(`advanced_elastic_dialog_map and advanced_typeform_elastic_map`)
  console.log('\n \n')
  const x = [
    uploadS3(URL_advanced_elastic_dialog_map, JSON.stringify(advanced_elastic_dialog_map)),
    uploadS3(URL_advanced_typeform_elastic_map, JSON.stringify(advanced_typeform_elastic_map))
  ]
  Promise.all(x)
    .then((data) => {
